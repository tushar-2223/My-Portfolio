  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent max-w-4xl">
          My Professional Journey
        </h2>
        <p className="text-neutral-300 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          Here&apos;s my career timeline showcasing key milestones and achievements in web development.
        </p>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-blue-500 dark:bg-blue-500 border border-blue-400 dark:border-blue-400 p-2" />
              </div>

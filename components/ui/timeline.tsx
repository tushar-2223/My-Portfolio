                ...
                {data.map((item, index) => (
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <div className="h-4 w-4 md:h-10 absolute left-6 md:left-3 md:w-10 rounded-full bg-black flex items-center justify-center">
                                <div className="h-1.5 w-1.5 md:h-4 md:w-4 rounded-full bg-neutral-800 border border-neutral-700" />
                            </div>

    ...
    <section id="home" className="relative bg-black">
      <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 pt-24 min-h-screen bg-black">
        <div className="relative z-20 text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-b from-white to-white/70 bg-clip-text text-transparent leading-tight tracking-tight">
            Hey, I'm Tushar
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Button size="lg" className="bg-white text-black hover:bg-white/90 px-8 py-3 font-medium ">
              View My Work
            </Button>
            <Button variant="outline" size="lg" className="border-white/30 text-white hover:bg-white/5 px-8 py-3 font-medium ">
